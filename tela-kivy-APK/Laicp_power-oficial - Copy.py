...
from Apimodel import scaler_x, scaler_y, hum_avg, temp_avg, modelo
import pandas as pd
...
class NavBar(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.dashboard_button = Button(text='Dashboard', on_press=self.switch_to_dashboard)
...
class DashboardScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.devices_on_label = Label(text="", size_hint=(0.9, 0.1))
        self.layout.add_widget(self.devices_on_label)
        
        self.consumption_input = TextInput(hint_text='Consumo atual', multiline=False, height=30, size_hint=(0.9, 0.2))  # Alterado aqui
        self.layout.add_widget(self.consumption_input)
        
        self.predict_button = Button(text="Prever consumo do dia seguinte", height=30, size_hint=(0.9, 0.2), on_press=self.predict_consumption)  # Alterado aqui
